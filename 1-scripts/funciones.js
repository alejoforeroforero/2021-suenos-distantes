...
function construirMenu() {
    ...
    menu.audio.src = "3-audio/morse1.mp3";
    menu.pintar();
    ...
    menu.titulo = 'Visión';
    menu.audio = new Audio();
    menu.audio.src = "3-audio/morse2.mp3";
    menu.pintar();
    ...
    menu.titulo = 'Memoria';
    menu.audio = new Audio();
    menu.audio.src = "3-audio/morse3.mp3";
    menu.pintar();
    ...
    menu.audio = new Audio();
    menu.audio.src = "3-audio/morse4.mp3";
    menu.pintar();
    ...
    menu.audio = new Audio();
    menu.audio.src = "3-audio/morse5.mp3";
    menu.pintar();

    audioPlanetas = new Audio();
    audioPlanetas.src = "3-audio/planetas.mp3?n=1";

    audioTerremoto = new Audio();
    audioTerremoto.src = "3-audio/terremoto.mp3";
}
...
function ponerNiebla() {
    ...
    videoFondo.src = "4-videos/niebla.mp4";
    videoFondo.style.display = 'block';
...
function ponerVertices() {
    ...
    /*	divObrasG.style.display = 'block';
    	...
    	var div = cE("div",divObras);
    	div.className = "infoFechas";
    	div.innerHTML = "Performance de improvisación telemática<br>"+
    	"Ximena Alarcón y colectivo Vértices<br>"+
    	"Colombia <br><br>"+ 
    	"Esta pieza se presentará en las siguientes fechas:<br><br>"+ 
    	"<span class='infoEvento2'> Sábado 31 de octubre, 4:00 p.m.</span><br>"+
    	"<span class='infoEvento2'> Miércoles 4 de noviembre, 5:00 p.m..</span><br><br>"+
    	...
    	var video = cE("video", divObras);
    	video.src = "4-videos/verticest.mp4";
    	video.style.display = "block";
    	video.style.opacity = 1;
    	video.className = "vVertices";
    	video.play();*/
}
