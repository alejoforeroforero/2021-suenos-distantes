...
function descargarArchivos() {
    if (indiceArchivos == 0) {
        ...
        videoFondo.src = '4-videos/explosion3.mp4?n=3';
        ...
        //dakarTrailer = createVideo(['4-videos/dakart.mp4?n=3'], continuarDescarga);

        continuarDescarga();
    } else if (indiceArchivos == 3) {
        dakarFondoV = createVideo(['4-videos/dakarv.mp4?n=3'], continuarDescarga);
        ...
        //jaguarTrailer = createVideo(['4-videos/jaguart.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 6) {
        jaguarFondoV = createVideo(['4-videos/jaguarv.mp4?n=3'], continuarDescarga);
        ...
        //dreamTrailer = createVideo(['4-videos/dreamt.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 9) {
        dreamFondoV = createVideo(['4-videos/dreamv.mp4?n=3'], continuarDescarga);
        ...
        //verticesTrailer = createVideo(['4-videos/verticest.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 12) {
        verticesFondoV = createVideo(['4-videos/verticesv.mp4?n=3'], continuarDescarga);
        ...
        //spaceTrailer = createVideo(['4-videos/spaceoutt.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 15) {
        spaceFondoV = createVideo(['4-videos/spaceoutv.mp4?n=3'], continuarDescarga);
        ...
        //n8Trailer = createVideo(['4-videos/n8t.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 18) {
        n8FondoV = createVideo(['4-videos/n8v.mp4?n=3'], continuarDescarga);
        n8FondoV.volume(0);
    } else if (indiceArchivos == 19) {
        pandemicImg = loadImage('2-imagenes/pandemic.jpg?n=3', continuarDescarga);
    } else if (indiceArchivos == 20) {
        //pandemicTrailer = createVideo(['4-videos/pandemict.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 21) {
        pandemicFondoV = createVideo(['4-videos/pandemicv.mp4?n=3'], continuarDescarga);
        ...
        //promesaTrailer = createVideo(['4-videos/promesat.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 24) {
        promesaFondoV = createVideo(['4-videos/promesav.mp4?n=3'], continuarDescarga);
        ...
        //parasomniasTrailer = createVideo(['4-videos/parasomniast.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 27) {
        parasomniasFondoV = createVideo(['4-videos/parasomniasv.mp4?n=3'], continuarDescarga);
        parasomniasFondoV.volume(0);
    } else if (indiceArchivos == 28) {
        //nieblaV = createVideo(['4-videos/niebla.mp4?n=3'], continuarDescarga);
        continuarDescarga();
    } else if (indiceArchivos == 29) {
        audioIntro = new Audio();
        audioIntro.src = "3-audio/entrada.mp3";
        continuarDescarga();
    } else {
...
function descargarArchivosFirefox() {
    if (indiceArchivos == 0) {
        ...
        /*var dakarTrailerF = cE('video', document.body);
        dakarTrailerF.src = '4-videos/dakart.mp4?n=3';		
        dakarTrailerF.oncanplay = function()
        {
        	dakarTrailer = createVideo('4-videos/dakart.mp4?n=3');
        ...
        dakarFondoVF.src = '4-videos/dakarv.mp4?n=3';
        dakarFondoVF.oncanplay = oncanplay = function() {
            dakarFondoV = createVideo('4-videos/dakarv.mp4?n=3');
            dakarFondoV.volume(0);
            continuarDescargaFirefox();
        }
    } else if (indiceArchivos == 4) {
        ...
        /*	var jaguarTrailerF = cE('video', document.body);
        	jaguarTrailerF.src = '4-videos/jaguart.mp4?n=3';
        	jaguarTrailerF.oncanplay = function()
        	{
        		jaguarTrailer = createVideo('4-videos/jaguart.mp4?n=3');
        		continuarDescargaFirefox();
        	}*/
        ...
        jaguarFondoVF.src = '4-videos/jaguarv.mp4?n=3';
        jaguarFondoVF.oncanplay = function() {
            jaguarFondoV = createVideo('4-videos/jaguarv.mp4?n=3');
            jaguarFondoV.volume(0);
            continuarDescargaFirefox();
        };
    } else if (indiceArchivos == 7) {
        ...
        /*var dreamTrailerF = cE('video', document.body);
        dreamTrailerF.src = '4-videos/dreamt.mp4?n=3';
        dreamTrailerF.oncanplay = function()
        {
        	dreamTrailer = createVideo('4-videos/dreamt.mp4?n=3');
        	continuarDescargaFirefox();
        };*/
        ...
        dreamFondoVF.src = '4-videos/dreamv.mp4?n=3';
        dreamFondoVF.oncanplay = function() {
            dreamFondoV = createVideo('4-videos/dreamv.mp4?n=3');
            dreamFondoV.volume(0);
            continuarDescargaFirefox();
        };
    } else if (indiceArchivos == 10) {
        ...
        /*var verticesTrailerF = cE('video', document.body);
        verticesTrailerF.src = '4-videos/verticest.mp4?n=3';
        verticesTrailerF.oncanplay = function()
        {
        	verticesTrailer = createVideo('4-videos/verticest.mp4?n=3');
        	continuarDescargaFirefox();
        };*/
        ...
        verticesFondoVF.src = '4-videos/verticesv.mp4?n=3';
        verticesFondoVF.oncanplay = function() {
            verticesFondoV = createVideo('4-videos/verticesv.mp4?n=3');
            verticesFondoV.volume(0);
            continuarDescargaFirefox();
        };
    } else if (indiceArchivos == 13) {
        ...
        /*spaceTrailerF = cE('video', document.body);
        spaceTrailerF.src = '4-videos/spaceoutt.mp4?n=3';
        spaceTrailerF.oncanplay = function()
        {
        	spaceTrailer = createVideo('4-videos/spaceoutt.mp4?n=3');
        	continuarDescargaFirefox();
        };*/
        ...
        spaceFondoVF.src = '4-videos/spaceoutv.mp4?n=3';
        spaceFondoVF.oncanplay = function() {
            spaceFondoV = createVideo('4-videos/spaceoutv.mp4?n=3');
            spaceFondoV.volume(0);
            continuarDescargaFirefox();
        };
    } else if (indiceArchivos == 16) {
        ...
        n8FondoVF.src = '4-videos/n8v.mp4?n=3';
        n8FondoVF.oncanplay = function() {
            n8FondoV = createVideo('4-videos/n8v.mp4?n=3');
            n8FondoV.volume(0);
            continuarDescargaFirefox();
        };
    } else if (indiceArchivos == 19) {
        ...
        pandemicFondoVF.src = '4-videos/pandemicv.mp4?n=3';
        pandemicFondoVF.oncanplay = function() {
            pandemicFondoV = createVideo('4-videos/pandemicv.mp4?n=3');
            pandemicFondoV.volume(0);
            continuarDescargaFirefox();
        };
    } else if (indiceArchivos == 22) {
        ...
        promesaFondoVF.src = '4-videos/promesav.mp4?n=3';
        promesaFondoVF.oncanplay = function() {
            promesaFondoV = createVideo('4-videos/promesav.mp4?n=3');
            promesaFondoV.volume(0);
            continuarDescargaFirefox();
        };
    } else if (indiceArchivos == 25) {
        ...
        /*var parasomniasTrailerF = cE('video', document.body);
        parasomniasTrailerF.src = '4-videos/parasomniast.mp4?n=3';
        parasomniasTrailerF.oncanplay = function()
        {
        	parasomniasTrailer = createVideo('4-videos/parasomniast.mp4?n=3');
        	continuarDescargaFirefox();
        };*/
        ...
        parasomniasFondoVF.src = '4-videos/parasomniasv.mp4?n=3';
        parasomniasFondoVF.oncanplay = function() {
            parasomniasFondoV = createVideo('4-videos/parasomniasv.mp4?n=3');
            parasomniasFondoV.volume(0);
            continuarDescargaFirefox();
        };
    } else if (indiceArchivos == 28) {
        nieblaV = cE('video', document.body);
        nieblaV.src = '4-videos/niebla.mp4?n=3';
